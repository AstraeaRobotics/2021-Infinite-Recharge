...
public class DifferentialDrive extends RobotDriveBase implements Sendable, AutoCloseable {
   ...
   */
  public DifferentialDrive(CANSparkMax leftMotor, CANSparkMax rightMotor) {
  ...
  public void arcadeDrive(double xSpeed, double zRotation, boolean squareInputs) {
    ...
    double maxOutput = m_rightSideInvertMultiplier;
  ...
  public void curvatureDrive(double xSpeed, double zRotation, boolean isQuickTurn) {
    ...
    CANEncoder leftEnc = m_leftMotor.getEncoder();
    CANEncoder rightEnc = m_rightMotor.getEncoder();

    CANPIDController leftPid = m_leftMotor.getPIDController();
    CANPIDController rightPid = m_rightMotor.getPIDController();
    ...
    leftPid.setReference(leftMotorOutput * 11000, ControlType.kVelocity);
    rightPid.setReference(rightMotorOutput * m_rightSideInvertMultiplier * 11000, ControlType.kVelocity);
